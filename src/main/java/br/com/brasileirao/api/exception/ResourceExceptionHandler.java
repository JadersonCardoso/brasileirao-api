...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<StandardError> forbiddenExceptiontException(ForbiddenException e, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(new StandardError(HttpStatus.FORBIDDEN, e.getMessage(), request.getRequestURI()));
    }

    @ExceptionHandler(NotFoundException.class)
    public ResponseEntity<StandardError> notFoundExceptionException(NotFoundException e, HttpServletRequest request) {
